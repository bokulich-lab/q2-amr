...
from q2_amr.annotate_mags_card import annotate_mags_card, run_rgi_main
...
class TestAnnotateMagsCard(TestPluginBase):
    ...
    def test_annotate_mags_card(self):
        ...
        with patch(
            "q2_amr.annotate_mags_card.run_rgi_main", side_effect=mock_run_rgi_main
        ), patch("q2_amr.annotate_mags_card.load_preprocess_card_db"):
    ...
    def test_run_rgi_main(self):
        with patch("q2_amr.annotate_mags_card.run_command") as mock_run_command:
            run_rgi_main(
    ...
    @patch("q2_amr.annotate_mags_card.run_command")
